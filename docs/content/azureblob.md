...
MD5 sums aren't uploaded with chunked upload files.  This should be
possible but I haven't made it work yet.

Azure Blob Storage should preserve Mime types, but it doesn't yet
until [this issue](https://github.com/Azure/azure-sdk-for-go/pull/702)
is resolved.
